    ...
    const menuItemns = [
        {
            ...
            type: "veg",
            price: 110,
            img: "/public/veg--fried rice.jpeg"
        },
        {
            id: 2,
            name: "Veg Biryani",
        ...
        },
        {
            ...
            type: "non-veg",
            price: 180,
            img: "/public/chicken-biryani.jpg",
        },
        {
            id: 4,
            name: "Chicken Curry",
        ...
        },
        {
            ...
            type: "veg",
            price: 160,
            img: "/public/paneer-butter-masala.jpg",
        },
        {
            id: 7,
            name: "Masala Dosa",
        ...
        },
        {
            ...
            type: "non-veg",
            price: 220,
            img: "/public/mutton-biryani.jpeg",
        },
        {
            id: 10,
            name: "Fish Curry",
        ...
        },
        {
            ...
            type: "non-veg",
            price: 250,
            img: "/public/tandoori-chicken.jpg",
        },
        {
            id: 16,
            name: "Beef Fry",
            ...
            <div className="min-h-screen w-screen bg-[url('/public/food.jpg')] bg-repeat bg-center">
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-center p-4 bg-yellow-200">
                        <h1 className="text-3xl font-[Arial] text-gray-900 font-bold">Student Menu</h1>
                        <div className='p-1' >
